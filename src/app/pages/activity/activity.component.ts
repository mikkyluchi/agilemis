...
import { PlanuploadmodalComponent } from "src/app/modal/planuploadmodal/planuploadmodal.component";
...
export class ActivityComponent implements OnInit {
  ...
  planUpload(){
    ...
    const modalRef = this.bsModalService.show(PlanuploadmodalComponent, { class: 'modal-xl', initialState });
  ...
  deleteProjectById() {
    this.crud.deleteAuthData(`projects/${this.projectId}`)
      .subscribe((res: any) => {
        this.toastr.success(res.message);
  ...
  openModal(item: any) {
    ...
    modalRef.componentInstance.sub_component_id = this.sub_component_id;
