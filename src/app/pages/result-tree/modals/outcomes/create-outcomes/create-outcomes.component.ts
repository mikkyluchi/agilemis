...
@Component({
  ...
  templateUrl: './create-outcomes.component.html',
  styleUrls: ['./create-outcomes.component.css']
})
export class CreateOutcomesComponent implements OnInit {
  // @Input() data;
  data: any;
  postData: any = { states: [] };
  submit: any;
  ...
  create(data) {
    ...
    this.crud.postAuthData('sub-outcomes', this.postData).subscribe(
      res => {
