...
@Component({
  selector: 'edit-sub-output',
  templateUrl: './edit-sub-output.component.html',
  styleUrls: ['./edit-sub-output.component.scss']
})
export class EditSubOutputComponent implements OnInit {
  data: any;
  type: any = '';
  postData: any;
  submit: any;
  ...
  create() {
    ...
    this.crud.putAuthData(`sub-outputs/${this.data.id}`, this.postData).subscribe(
      res => {
        this.activeModal.hide();
        this.onClose.next(false);
        this.toastr.success("Sub Output successful updated");
      },
      error =>{
