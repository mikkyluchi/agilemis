...
@Component({
  ...
  templateUrl: './edit-sub-pdo-indicator.component.html',
  styleUrls: ['./edit-sub-pdo-indicator.component.css']
})
export class EditSubPdoIndicatorComponent implements OnInit {
  data: any = {};
  postData: any = {};
  submit: any;
  sh: any;
  ...
  create(data) {
    this.submit = true;
    this.crud.putAuthData(`sub-pdo-indicators/${this.postData.id}`, this.postData).subscribe(
      res => {
