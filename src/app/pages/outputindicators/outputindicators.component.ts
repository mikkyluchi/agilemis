...
import { OutputicommentsmodalComponent } from '../outputicommentsmodal/outputicommentsmodal.component';

@Component({
  selector: 'outputindicators',
  templateUrl: './outputindicators.component.html',
  styleUrls: ['./outputindicators.component.scss']
})
export class OutputindicatorsComponent implements OnInit {
  item:any;
  viewComments = false;
  currentUserObj:any;
  form: FormGroup;
  ...
  intermediateoutcomeindicatorgroupsresultunapproved:any;
  quarters:any;
  lgas:any;
  constructor(
  ...
  ngOnInit() {
    ...
    this.getOutputIndicatorsResultsUnapproved()
    this.getYears();
    this.getQuarters();
    this.getLGAs();
  ...
  getAllOutputValues(){
    this.crud.postCCAuthData('outputindicator/getstatevalues', this.form.value, sessionStorage.getItem('user')).subscribe(
      (res: any) => {
        this.toastr.success(res.payload)
        this.intermediateoutcomeindicatorgroupsresultunapproved = res.payload;
      },
      (error)=>{
  ...
  getOutputIndicatorsResultsUnapproved() {
    this.spinner.show();
    this.crud.getCCAuthData('outputindicatorresultsunapproved?user='+this.user.id).subscribe((res: any) => {
      this.intermediateoutcomeindicatorgroupsresultunapproved = res.payload
      this.spinner.hide();
    },
      error => {
  ...
  deleteProjectById() {
    ...
    this.crud.deleteCCAuthData('outputindicatordelete', this.projectId).subscribe(
      (res: any) => {
        this.toastr.success(res.message);
  ...
  deleteProjectByIddd() {
    ...
    this.crud.deleteCCAuthData('outputindicatorvalueapprove', this.projectId).subscribe(
      (res: any) => {
        this.toastr.success(res.message);
        document.getElementById('closeDelProjectModal').click();
      },
  ...
  enableProjectByIddd() {
    ...
    this.crud.deleteCCAuthData('outputindicatorvalueenable', this.projectId).subscribe(
      (res: any) => {
        this.toastr.success(res.message);
        document.getElementById('closeDelProjectModal').click();
      },
  ...
  disableProjectByIddd() {
     
    this.crud.deleteCCAuthData('outputindicatorvaluedisable', this.projectId).subscribe(
      (res: any) => {
        this.toastr.success(res.message);
        document.getElementById('closeDelProjectModal').click();
      },
  ...
  editCommentsModal(item){
    
    const modalRef = this.modalService.open(OutputicommentsmodalComponent);
    modalRef.componentInstance.src = item;
    // this.item = item
  ...
  approveOIData(item){
    this.spinner.show()
    this.crud.postCCCAuthData('outcomes/approveOIData', JSON.stringify({ id: item.id })).subscribe(
      (res: any) => {
        //this.projects = res?.payload
        this.spinner.hide()
      },
  ...
  unapproveOIData(item){
    this.spinner.show()
    this.crud.postCCCAuthData('outcomes/unapproveOIData', JSON.stringify({ id: item.id })).subscribe(
      (res: any) => {
        //this.projects = res?.payload
        this.spinner.hide()
      },
